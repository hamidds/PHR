...
def generate_random_num():
    ...
    tn.append(sorted(random_n_base(10, 20, start = 10, count=26)))
    ...
    tn.append(sorted(random_n_base(10, 91, start=20, step = 10, count=26)))
    ...
    tn.append(sorted(random_n_base(12, 10, count=26)))
    #print(tn[-1])            #12 digits              100,000,000,000 - 200,000,000,000 - ... - 900,000,000,000

    #print("with zeros:")
    tn.append(sorted(random_n_base(4, count=70, mode="with_zeros")))
    #print(tn[-1])
