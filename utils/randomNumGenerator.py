...
def generate_random_num():
    ...
    tn.append(sorted(random_n_base(10, 20, start = 10)))
    ...
    tn.append(sorted(random_n_base(10, 91, start=20, step = 10)))
    ...
    tn.append(sorted(random_n_base(12, 10)))
